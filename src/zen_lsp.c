...
int zenroom_start_lsp(int verbosity) {
	zenroom_t *Z = lsp_init();
	if(!Z) {
	...
	int r;
	notice(L,"Starting the Zenroom Language-Server");
	r = lsp_start(Z);
